...
/**
 * ExampleClient.java Provides example calls to WordLadderGame methods in an instance of the
 * Doublets class. The word list files must be extracted into the current directory before running
 * this class. jar xf WordLists.jar
 *
